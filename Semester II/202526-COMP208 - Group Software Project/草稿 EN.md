...
gantt
    ...
    section Phases...
    Phase 1            :active, des1, 2026-02-07, 2026-02-16
    Phase 2 (Development)         :crit, des2, 2026-02-17, 2026-04-10
    Phase 3    :active, des3, 2026-04-11, 2026-04-20
    Phase 4        :des4, 2026-04-20, 2026-04-24
    Phase 5        :des5, 2026-04-25, 2026-05-11
```
...
```mermaid
gantt
    title Project Development Detailed Schedule
    dateFormat  YYYY-MM-DD
    axisFormat  %m-%d

    section Phase 1: Req & Basics
    Req Analysis Doc (Due 2-16)    :active, 2026-02-07, 2026-02-16
    Env Setup (Git/DB/Nginx/Swagger)        :2026-02-17, 2026-02-23
    Employee & Category Mgmt Module     :2026-02-24, 2026-03-05

    section Phase 2: Admin Business
    Common Field Auto-fill Impl   :2026-03-06, 2026-03-10
    Dish & Set Meal Mgmt (Backend+Vue) :2026-03-11, 2026-03-22

    section Phase 3: User & Core
    Redis Cache & Status Control       :2026-03-23, 2026-03-31
    WeChat Login & Product Browsing         :2026-04-01, 2026-04-08
    Cart, Order & Payment Logic    :2026-04-09, 2026-04-15

    section Phase 4: Adv & Demo
    Spring Task & WebSocket (Notify)     :2026-04-16, 2026-04-20
    Video Recording & Editing (Due 4-20)   :2026-04-11, 2026-04-20
    Demo Video Submission                :milestone, m2, 2026-04-20, 0d

    section Phase 5: Analysis & Design
    ECharts & Operation Stats   :2026-04-21, 2026-04-30
    POI Excel Export & System Test       :2026-05-01, 2026-05-07
    Final Design Doc (Due 5-11)            :2026-04-21, 2026-05-11
```

```mermaid
gantt
    title Project Deliverables & Overlap View
    dateFormat  YYYY-MM-DD
    axisFormat  %m-%d

    section Documentation
    Requirements Analysis Phase (Due 2-16) :active, 2026-02-07, 2026-02-16
    Design Phase Docs (Due 5-11) :2026-04-21, 2026-05-11

    section Software Development
    Infrastructure & Admin Modules            :2026-02-17, 2026-03-22
    User App & Core Logic (Pay/Order)     :2026-03-23, 2026-04-15
    Advanced Features & Final Polish       :2026-04-16, 2026-05-07

    section Presentation Phase
    Demo Prep (Video/PPT)               :2026-04-11, 2026-04-20
    Project Demo Submission (Due 4-20)       :milestone, m1, 2026-04-20, 0d
    Q&A Session Window                        :2026-04-20, 2026-04-24
```
